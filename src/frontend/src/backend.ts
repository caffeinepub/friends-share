...
import type { CommentId as _CommentId, ExternalBlob as _ExternalBlob, PostId as _PostId, PostView as _PostView, ProfileId as _ProfileId, UserProfileView as _UserProfileView, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addFriend(arg0: ProfileId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createProfile(arg0: string, arg1: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createProfile(arg0, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPostsSorted(): Promise<Array<PostView>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPostsSorted();
    ...
    async getFriends(): Promise<Array<ProfileId>> {
        if (this.processError) {
            try {
    ...
    async getMessagesWith(arg0: ProfileId): Promise<Array<Message>> {
        if (this.processError) {
            try {
    ...
    async sendMessage(arg0: ProfileId, arg1: string): Promise<MessageId> {
        if (this.processError) {
            try {
...
async function from_candid_UserProfileView_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _UserProfileView): Promise<UserProfileView> {
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_UserProfileView]): Promise<UserProfileView | null> {
    return value.length === 0 ? null : await from_candid_UserProfileView_n18(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    id: _PostId;
    author: _ProfileId;
    likes: Array<_ProfileId>;
    timestamp: bigint;
    caption: string;
    comments: Array<_CommentId>;
    photo: [] | [_ExternalBlob];
}): Promise<{
    id: PostId;
    author: ProfileId;
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PostView>): Promise<Array<PostView>> {
